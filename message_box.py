...
class SPECIFICATION_SHEET_OT_messagebox(Operator):
    bl_idname = 'specification_sheet.messagebox'
    bl_label = ''
...
def register():
    register_class(SPECIFICATION_SHEET_OT_messagebox)


def unregister():
    unregister_class(SPECIFICATION_SHEET_OT_messagebox)
